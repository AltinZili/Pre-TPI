...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-1 col-xl-1" style="padding-top: 4px">
            <input class="form-check-input radiobuttonsize" type="radio" name="radiobuttons" value=1 id="radioresponseone" required>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-1 col-xl-1" style="padding-top: 4px">
            <input class="form-check-input radiobuttonsize" type="radio" name="radiobuttons" value=2 id="radioresponsetwo" required>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-1 col-xl-1" style="padding-top: 4px">
            <input class="form-check-input radiobuttonsize" type="radio" name="radiobuttons" value=3 id="radioresponsethree" required>
        </div>
    ...
    <div class="row">
        ...
        <div class=" col-1 col-xl-1" style="padding-top: 4px">
            <input class="form-check-input radiobuttonsize" type="radio" name="radiobuttons" value=4 id="radioresponsefour" required>
        </div>
    </div>
    </form>
</div>
