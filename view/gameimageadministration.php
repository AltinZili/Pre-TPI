...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-3 col-xl-3"><h1>Entrer image:</h1></div>
        <div class="col-2 col-xl-2" style="padding-top: 15px;">
            <input type="file" name="chooseimage" id="chooseimage" class="filestyle" ata-classButton="btn btn-primary" data-input="false" data-classIcon="icon-plus" data-buttonText="choisssez une image" accept="image/png, image/gif, image/jpeg" />
        </div>
